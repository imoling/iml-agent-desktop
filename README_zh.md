...
![启动界面](docs/images/1.开始界面.png)

## 📸 界面预览

| ![技能生态](docs/images/2.技能列表.png) | ![记忆管理](docs/images/3.记忆管理.png) |
|:---:|:---:|
| **技能生态** | **记忆管理** |

| ![通用设置](docs/images/4.通用设置.png) | ![上下文管理](docs/images/5.上下文管理.png) |
|:---:|:---:|
| **通用设置** | **上下文管理** |

| ![录音设置](docs/images/6.录音设置.png) | ![功能演示](docs/images/7.功能演示.png) |
|:---:|:---:|
| **录音设置** | **功能演示** |

| ![创意产出 (海报)](docs/images/7.1.海报产物.png) | ![深色模式与多语言](docs/images/8.黑色模式+多语种.png) |
|:---:|:---:|
| **创意产出 (海报)** | **深色模式与多语言** |
